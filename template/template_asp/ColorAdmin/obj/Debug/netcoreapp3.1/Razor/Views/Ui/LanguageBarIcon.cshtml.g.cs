#pragma checksum "/Users/ngunguoksiong/color-admin/admin/template/template_asp/ColorAdmin/Views/Ui/LanguageBarIcon.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c004967fc6bb11cd81b10e86b3ae3bd38cc8e92a"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Ui_LanguageBarIcon), @"mvc.1.0.view", @"/Views/Ui/LanguageBarIcon.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c004967fc6bb11cd81b10e86b3ae3bd38cc8e92a", @"/Views/Ui/LanguageBarIcon.cshtml")]
    ...
    public class Views_Ui_LanguageBarIcon : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "/Users/ngunguoksiong/color-admin/admin/template/template_asp/ColorAdmin/Views/Ui/LanguageBarIcon.cshtml"
  
  ViewData["Title"] = "Language Bar & Icon";
  ViewData["PageHeaderLanguageBar"] = "true";
...
#nullable disable
            DefineSection("Styles", async() => {
                WriteLiteral("\r\n\t");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "c004967fc6bb11cd81b10e86b3ae3bd38cc8e92a4176", async() => {
                }
                );
...
<div class=""panel panel-inverse"">
	...
	<div class=""panel-heading"">
		...
		<div class=""panel-heading-btn"">
			...
			<a href=""javascript:;"" class=""btn btn-xs btn-icon btn-circle btn-warning"" data-clic");
            WriteLiteral(@"k=""panel-collapse""><i class=""fa fa-minus""></i></a>
	...
	<div class=""panel-body"">
		...
		<div class=""row"">
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-ag width-full m-r-10 m-t-0 m-b-3"" title=");
            WriteLiteral(@"""ag"" id=""ag""></h2> <b class=""text-inverse"">AG</b></div>
            ...
            WriteLiteral(@" col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-ar width-full m-r-10 m-t-0 m-b-3"" title=""ar"" id=""ar""></h2> <b class=""text-inverse"">AR</b></div>
		...
		<div class=""row"">
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 te");
            WriteLiteral(@"xt-center""><h2 class=""flag-icon flag-icon-ax width-full m-r-10 m-t-0 m-b-3"" title=""ax"" id=""ax""></h2> <b class=""text-inverse"">AX</b></div>
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-be width-full m-r-10 m-t-0 m-b-3"" title=""be"" id");
            WriteLiteral(@"=""be""></h2> <b class=""text-inverse"">BE</b></div>
		...
		<!-- begin row -->
		<div class=""row"">
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-bj width-full m-r-10 m-t-0 m-b-3"" title=""bj"" id=""bj""></h2> <b c");
            WriteLiteral(@"lass=""text-inverse"">BJ</b></div>
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-cent");
            WriteLiteral(@"er""><h2 class=""flag-icon flag-icon-br width-full m-r-10 m-t-0 m-b-3"" title=""br"" id=""br""></h2> <b class=""text-inverse"">BR</b></div>
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-by width-full m-r-10 m-t-0 m-b-3"" title=""by"" id=""by""><");
            WriteLiteral(@"/h2> <b class=""text-inverse"">BY</b></div>
		</div>
		<!-- end row -->
		<!-- begin row -->
		<div class=""row"">
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-cf width-full m-r-10 m-t-0 m-b-3"" title=""cf"" id=""cf""></h2> <b class=""t");
            WriteLiteral(@"ext-inverse"">CF</b></div>
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2");
            WriteLiteral(@" class=""flag-icon flag-icon-cm width-full m-r-10 m-t-0 m-b-3"" title=""cm"" id=""cm""></h2> <b class=""text-inverse"">CM</b></div>
		...
		<div class=""row"">
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-ico");
            WriteLiteral(@"n flag-icon-cv width-full m-r-10 m-t-0 m-b-3"" title=""cv"" id=""cv""></h2> <b class=""text-inverse"">CV</b></div>
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-de width-full m-r-10 m-t-0 m-b-3"" title=""de"" id=""de""></h2> <b class=""text-inv");
            WriteLiteral(@"erse"">DE</b></div>
		...
		<div class=""row"">
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-dz width-full m-r-10 m-t-0 m-b-3"" title=""dz"" id=""dz""></h2> <b class=""text-inverse"">DZ</b></di");
            WriteLiteral(@"v>
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-");
            WriteLiteral(@"icon-es width-full m-r-10 m-t-0 m-b-3"" title=""es"" id=""es""></h2> <b class=""text-inverse"">ES</b></div>
		...
		<!-- begin row -->
		<div class=""row"">
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-fm width-fu");
            WriteLiteral(@"ll m-r-10 m-t-0 m-b-3"" title=""fm"" id=""fm""></h2> <b class=""text-inverse"">FM</b></div>
			...
			");
            WriteLiteral(@"<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-ge width-full m-r-10 m-t-0 m-b-3"" title=""ge"" id=""ge""></h2> <b class=""text-inverse"">GE</b></div>
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-gl");
            WriteLiteral(@" width-full m-r-10 m-t-0 m-b-3"" title=""gl"" id=""gl""></h2> <b class=""text-inverse"">GL</b></div>
		</div>
		<!-- end row -->
		<!-- begin row -->
		<div class=""row"">
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-gr width-full m-r-");
            WriteLiteral(@"10 m-t-0 m-b-3"" title=""gr"" id=""gr""></h2> <b class=""text-inverse"">GR</b></div>
			...
			<div cl");
            WriteLiteral(@"ass=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-hk width-full m-r-10 m-t-0 m-b-3"" title=""hk"" id=""hk""></h2> <b class=""text-inverse"">HK</b></div>
		...
		<div class=""row"">
			...
			<div class=""col-md-1 co");
            WriteLiteral(@"l-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-hu width-full m-r-10 m-t-0 m-b-3"" title=""hu"" id=""hu""></h2> <b class=""text-inverse"">HU</b></div>
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-in width-full m-r-10 m-t-");
            WriteLiteral(@"0 m-b-3"" title=""in"" id=""in""></h2> <b class=""text-inverse"">IN</b></div>
		...
		<div class=""row"">
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-it width-full m-r-10 m-t-0 m-b-3"" title=""");
            WriteLiteral(@"it"" id=""it""></h2> <b class=""text-inverse"">IT</b></div>
			...
			<div class=""col-md-1 col-sm-2 ");
            WriteLiteral(@"col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-kg width-full m-r-10 m-t-0 m-b-3"" title=""kg"" id=""kg""></h2> <b class=""text-inverse"">KG</b></div>
		...
		<!-- begin row -->
		<div class=""row"">
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 tex");
            WriteLiteral(@"t-center""><h2 class=""flag-icon flag-icon-kp width-full m-r-10 m-t-0 m-b-3"" title=""kp"" id=""kp""></h2> <b class=""text-inverse"">KP</b></div>
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-la width-full m-r-10 m-t-0 m-b-3"" title=""la"" id=");
            WriteLiteral(@"""la""></h2> <b class=""text-inverse"">LA</b></div>
			...
			<div class=""col-md-1 col-sm-2 col-3 m");
            WriteLiteral(@"-b-10 text-center""><h2 class=""flag-icon flag-icon-ls width-full m-r-10 m-t-0 m-b-3"" title=""ls"" id=""ls""></h2> <b class=""text-inverse"">LS</b></div>
		</div>
		<!-- end row -->
		<!-- begin row -->
		<div class=""row"">
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-cente");
            WriteLiteral(@"r""><h2 class=""flag-icon flag-icon-ma width-full m-r-10 m-t-0 m-b-3"" title=""ma"" id=""ma""></h2> <b class=""text-inverse"">MA</b></div>
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-mg width-full m-r-10 m-t-0 m-b-3"" title=""mg"" id=""mg""></");
            WriteLiteral(@"h2> <b class=""text-inverse"">MG</b></div>
		...
		<div class=""row"">
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-mn width-full m-r-10 m-t-0 m-b-3"" title=""mn"" id=""mn""></h2> <b class=""te");
            WriteLiteral(@"xt-inverse"">MN</b></div>
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 ");
            WriteLiteral(@"class=""flag-icon flag-icon-mt width-full m-r-10 m-t-0 m-b-3"" title=""mt"" id=""mt""></h2> <b class=""text-inverse"">MT</b></div>
		...
		<div class=""row"">
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon");
            WriteLiteral(@" flag-icon-my width-full m-r-10 m-t-0 m-b-3"" title=""my"" id=""my""></h2> <b class=""text-inverse"">MY</b></div>
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-nf width-full m-r-10 m-t-0 m-b-3"" title=""nf"" id=""nf""></h2> <b class=""text-inve");
            WriteLiteral(@"rse"">NF</b></div>
		...
		<div class=""row""");
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-i");
            WriteLiteral(@"con-pe width-full m-r-10 m-t-0 m-b-3"" title=""pe"" id=""pe""></h2> <b class=""text-inverse"">PE</b></div>
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-pl width-full m-r-10 m-t-0 m-b-3"" title=""pl"" id=""pl""></h2> <b class=""text-inverse"">PL");
            WriteLiteral(@"</b></div>
		...
		<div class=""row"">
			...
			<");
            WriteLiteral(@"div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-pw width-full m-r-10 m-t-0 m-b-3"" title=""pw"" id=""pw""></h2> <b class=""text-inverse"">PW</b></div>
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-rs ");
            WriteLiteral(@"width-full m-r-10 m-t-0 m-b-3"" title=""rs"" id=""rs""></h2> <b class=""text-inverse"">RS</b></div>
		...
		<div class=""row"">
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-sc width-full m-r-1");
            WriteLiteral(@"0 m-t-0 m-b-3"" title=""sc"" id=""sc""></h2> <b class=""text-inverse"">SC</b></div>
			...
			<div cla");
            WriteLiteral(@"ss=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-sj width-full m-r-10 m-t-0 m-b-3"" title=""sj"" id=""sj""></h2> <b class=""text-inverse"">SJ</b></div>
		...
		<div class=""row"">
            ...
            WriteLiteral(@"-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-so width-full m-r-10 m-t-0 m-b-3"" title=""so"" id=""so""></h2> <b class=""text-inverse"">SO</b></div>
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-sx width-full m-r-10 m-t-0");
            WriteLiteral(@" m-b-3"" title=""sx"" id=""sx""></h2> <b class=""text-inverse"">SX</b></div>
		...
		<div class=""row"">
            ...
            WriteLiteral(@"ol-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-tm width-full m-r-10 m-t-0 m-b-3"" title=""tm"" id=""tm""></h2> <b class=""text-inverse"">TM</b></div>
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-tv width-full m-r-10 m-t-0 m-b-3""");
            WriteLiteral(@" title=""tv"" id=""tv""></h2> <b class=""text-inverse"">TV</b></div>
		...
		<div class=""row"">
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-um width-full m-r-10 m-t-0 m-b-3"" title=""um"" id=""");
            WriteLiteral(@"um""></h2> <b class=""text-inverse"">UM</b></div>
			...
			<div class=""col-md-1 col-sm-2 col-3 m-");
            WriteLiteral(@"b-10 text-center""><h2 class=""flag-icon flag-icon-ve width-full m-r-10 m-t-0 m-b-3"" title=""ve"" id=""ve""></h2> <b class=""text-inverse"">VE</b></div>
		...
		<div class=""row"">
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center");
            WriteLiteral(@"""><h2 class=""flag-icon flag-icon-wf width-full m-r-10 m-t-0 m-b-3"" title=""wf"" id=""wf""></h2> <b class=""text-inverse"">WF</b></div>
			...
			<div class=""col-md-1 col-sm-2 col-3 m-b-10 text-center""><h2 class=""flag-icon flag-icon-zm width-full m-r-10 m-t-0 m-b-3"" title=""zm"" id=""zm""></h");
            WriteLiteral(@"2> <b class=""text-inverse"">ZM</b></div>
