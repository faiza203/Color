						...
						<Panel>
							<PanelHeader noButton={true}>
								<UncontrolledDropdown className="pull-right">
									...
									<DropdownMenu>
										<DropdownItem><button type="button" className="btn btn-green-xs"><i className="fa fa-ticket-alt"></i> Add Card</button></DropdownItem>									
										<DropdownItem><button type="button" className="btn btn-lime-xs"><i className="far fa-edit"></i> Edit</button></DropdownItem>									
										<DropdownItem><button type="button" className="btn btn-orange-xs"><i className="far fa-file-pdf"></i> Save as PDF</button></DropdownItem>
										<DropdownItem><button type="button" className="btn btn-black-xs"><i className="far fa-trash-alt"></i> Delete</button></DropdownItem>
										<DropdownItem><button type="button" className="btn btn-gray-xs"><i className="fas fa-archive"></i> Archive</button></DropdownItem>										
										<DropdownItem divider />
										<DropdownItem><button type="button" className="btn btn-indigo-xs"><i className="ion-md-search"></i> Search in List</button></DropdownItem>
									</DropdownMenu>
							...
							<PanelHeader noButton={true}>
								<UncontrolledDropdown className="pull-right">
									...
									<DropdownMenu>
										...
										<DropdownItem><button type="button" className="btn btn-lime-xs"><i className="far fa-edit"></i> Edit</button></DropdownItem>									
										<DropdownItem><button type="button" className="btn btn-orange-xs"><i className="far fa-file-pdf"></i> Save as PDF</button></DropdownItem>
										<DropdownItem><button type="button" className="btn btn-red-xs"><i className="far fa-trash-alt"></i> Delete</button></DropdownItem>
										<DropdownItem><button type="button" className="btn btn-gray-xs"><i className="fas fa-archive"></i> Archive</button></DropdownItem>										
										<DropdownItem divider />
										<DropdownItem><button type="button" className="btn btn-indigo-xs"><i className="ion-md-search"></i> Search in List</button></DropdownItem>
									</DropdownMenu>
							...
							<PanelHeader noButton={true}>
								<UncontrolledDropdown className="pull-right">
									...
									<DropdownMenu>
										...
										<DropdownItem><button type="button" className="btn btn-black-xs"><i className="far fa-trash-alt"></i> Delete</button></DropdownItem>
										<DropdownItem><button type="button" className="btn btn-gray-xs"><i className="fas fa-archive"></i> Archive</button></DropdownItem>										
										<DropdownItem><button type="button" className="btn btn-lime-xs"><i className="fas fa-expand-arrows-alt"></i> Expand</button></DropdownItem>									
										<DropdownItem><button type="button" className="btn btn-orange-xs"><i className="fas fa-redo-alt"></i> Refresh</button></DropdownItem>
										<DropdownItem><button type="button" className="btn btn-red-xs"><i className="fas fa-compress"></i> Minimize</button></DropdownItem>
										<DropdownItem><button type="button" className="btn btn-red-xs"><i className="fas fa-window-close"></i> Close</button></DropdownItem>										
										<DropdownItem divider />
										<DropdownItem><button type="button" className="btn btn-indigo-xs"><i className="ion-md-search"></i> Search in List</button></DropdownItem>
									</DropdownMenu>
								</UncontrolledDropdown>
