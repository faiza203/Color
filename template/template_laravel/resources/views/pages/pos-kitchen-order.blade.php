						...
						<div class="pos-task-product-row">
							<div class="pos-task-product">
								...
								<div class="pos-task-product-action">
									...
									<a href="#" class="btn @@if (context.theme != 'transparent'){btn-outline-inverse}@@if (context.theme == 'transparent'){btn-default}">Cancel</a>
								</div>
							</div>
							<div class="pos-task-product">
								<div class="pos-task-product-img">
							...
							<div class="pos-task-product completed">
								...
								<div class="pos-task-product-action">
									...
									<a href="#" class="btn @@if (context.theme != 'transparent'){btn-outline-inverse}@@if (context.theme == 'transparent'){btn-default} disabled">Cancel</a>
								</div>
							</div>
						</div>
					</div>
